        ...
        if($request->isMethod('post')){
            ...
            if($user) {
                ...
                foreach($cioData as $cd){
                    ...
                    if($cd->updated_by == $user->id && $cd->receipt_id != null && date('Y-m-d', strtotime($cd->created_at)) == date('Y-m-d')){
                        $check_out++;
                        $income += $cd->fair;
                    }
                }
                foreach($vcioData as $vcd){
                    ...
                    if($vcd->updated_by == $user->id && $vcd->receipt_id != null && date('Y-m-d', strtotime($vcd->created_at)) == date('Y-m-d')){
                        $check_out++;
                    }
                }
                return response()->json([
